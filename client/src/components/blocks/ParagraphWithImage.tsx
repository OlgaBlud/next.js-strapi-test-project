...
import { ParagraphWithImageProps } from "@/src/types";
...
export function ParagraphWithImage({
  ...
  return (
    <div
      className={`article-text-image ${isReversed ? "article-text-image--reversed" : ""} ${imageLandscape ? "" : "article-text-image--portrait"}`}
    >
